...
class CustomCollector: Collector {
    ...
    struct Factory: ModuleFactory {
        ...
        func create(moduleId: String, context: TealiumContext, moduleConfiguration: DataObject) -> CustomCollector? {
            CustomCollector(context: context, moduleConfiguration: moduleConfiguration)
        }
    }
}
