...
class MockInterceptor: RequestInterceptor {
    ...
    init(waitingForConnectivity: @escaping WaitingForConnectivityBlock = { _ in },
         didComplete: @escaping DidCompleteBlock = { _, _ in },
         shouldRetry: @escaping ShouldRetryBlock = { _, _, _ in .doNotRetry }) {
