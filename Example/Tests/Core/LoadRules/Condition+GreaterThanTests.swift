...
final class ConditionGreaterThanTests: XCTestCase {
    ...
    func test_greaterThan_matches_number_strings() {
    ...
    func test_greaterThan_doesnt_match_NaN() {
        let condition = Condition.isGreaterThan(orEqual: false, variable: "nan", number: "0")
        XCTAssertFalse(condition.matches(payload: payload))
    }
    ...
    func test_greaterThan_doesnt_match_empty_string() {
        let condition = Condition.isGreaterThan(orEqual: false, variable: "emptyString", number: "-99")
        XCTAssertFalse(condition.matches(payload: payload))
    }

    func test_greaterThan_doesnt_match_when_filter_is_empty_string() {
