//
//  UpdateLaunchSleepWakeTests.swift
//  LifecycleTests_iOS
//
...
final class UpdateLaunchSleepWakeTests: LifecycleServiceBaseTests {
    ...
    func test_updateLaunchDate_is_defined_if_there_were_an_app_update() {
