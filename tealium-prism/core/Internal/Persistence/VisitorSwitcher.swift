...
class VisitorSwitcher {
     ...
     */
    static func handleIdentitySwitches(visitorIdProvider: VisitorIdProvider, onCoreSettings: Observable<CoreSettings>, dataLayerStore: any DataStore) -> any Disposable {
